...
public class thongkecontroller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            List<dichvu.ThongKeBean> dstke = thongKeTrungBinhLuong();
            request.setAttribute("dstke", dstke);
    ...
    private static java.util.List<dichvu.ThongKeBean> thongKeTrungBinhLuong() {
        dichvu.DichVu_Service service = new dichvu.DichVu_Service();
        dichvu.DichVu port = service.getDichVuPort();
        return port.thongKeTrungBinhLuong();
    }
