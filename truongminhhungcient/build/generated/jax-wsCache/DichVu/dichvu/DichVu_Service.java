 ...
 * 
 */
@WebServiceClient(name = "DichVu", targetNamespace = "http://DichVu/", wsdlLocation = "http://localhost:8080/truongminhhungserver/DichVu?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DICHVU_QNAME = new QName("http://DichVu/", "DichVu");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/truongminhhungserver/DichVu?wsdl");
    ...
    public DichVu getDichVuPort() {
        return super.getPort(new QName("http://DichVu/", "DichVuPort"), DichVu.class);
    }
    ...
    public DichVu getDichVuPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://DichVu/", "DichVuPort"), DichVu.class, features);
    }
